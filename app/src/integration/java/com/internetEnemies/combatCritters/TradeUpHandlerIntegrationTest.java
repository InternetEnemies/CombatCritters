...
public class TradeUpHandlerIntegrationTest {
    ...
    public void setup() throws IOException{
        ...
        testCommonCard1 = cardReg.add(new CritterCard(0,"","",0,Card.Rarity.COMMON,0,0,null));
        testCommonCard2 = cardReg.add(new CritterCard(0,"","",0,Card.Rarity.COMMON,0,0,null));
        testCommonCard3 = cardReg.add(new CritterCard(0,"","",0,Card.Rarity.COMMON,0,0,null));
        testCommonCard4 = cardReg.add(new CritterCard(0,"","",0,Card.Rarity.COMMON,0,0,null));
        testCommonCard5 = cardReg.add(new CritterCard(0,"","",0,Card.Rarity.COMMON,0,0,null));
        testCommonCard6 = cardReg.add(new CritterCard(0,"","",0,Card.Rarity.UNCOMMON,0,0,null));
        Card testCommonCard7 = cardReg.add(new CritterCard(0,"","",0,Card.Rarity.RARE,0,0,null));
