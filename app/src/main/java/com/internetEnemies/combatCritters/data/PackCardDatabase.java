...
public class PackCardDatabase {
    ...
    private PackCardDatabase() {
        ...
        cards.add(new ItemCard(44,"600 frag grenades", "card_id_60.png",2, Card.Rarity.RARE,1));
        cards.add(new ItemCard(45,"Friendship Pendant (Franklin)", "card_id_61.png",3, Card.Rarity.EPIC,2));
        cards.add(new ItemCard(46,"Friendship Pendant (Rob)", "card_id_62.png",3, Card.Rarity.EPIC,2));
